//jalali emami datepicker
/* Written by Emamirazavi (emamirazavi@gmail.com). 
 * @version 2.0.0 2013-03-21
 * one problem in leap year detection solved. see method setDate
You should test it more and more, but it's a good start!
Ya Mahdi Adrekni
 */
/**
 * 
...
/**
you think about year change but you don't think about month change!!!
*/
    jlDate.prototype.setDate = function(day)
    {
        if(day==null || isNaN(day)) return false;
        //this.month;
        //this.j_days_in_month
        var yearChange = parseInt(day/365);
        var monthChange = 0;
        day -= 365*yearChange;
        var restDay = day;//differece until first of current month
    ...
    jlDate.prototype.init = function(year, month, day, hours, minutes, seconds, milliseconds)
    {
        ...
        else if(this.isInteger(year))
        {
            ...
            if (year > 0 && year < 10000) {
                // you should set othe propeties like month and day
