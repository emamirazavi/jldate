...
newMomentProto.stripTime = function() {
	...
	if (!this._ambigTime) {
		...
		// commented by emamirazavi@gmail.com
...
setLocalValues = allowValueOptimization ? function(mom, a) {
	// simlate what moment's accessors do
	mom._d.setTime(+new jlDate( // FYI, there is now way to apply an array of args to a constructor
		a[0] || 0,
		a[1] || 0,
		a[2] || 0,
		a[3] || 0,
...
var View = fc.View = Class.extend({
	...
	// apparently end property has problem
